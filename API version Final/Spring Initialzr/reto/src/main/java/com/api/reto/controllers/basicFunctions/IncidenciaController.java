...
public class IncidenciaController {
    ...
    @PreAuthorize("hasAuthority('administrador') or hasAuthority('profesor')")
    public ResponseEntity<List<IncidenciaDTO>> obtenerIncidenciasPorTipo(@PathVariable("tipo") TipoEnum tipo) {
        List<IncidenciaDTO> incidencias = incidenciaService.obtenerIncidenciasPorTipo(tipo);
